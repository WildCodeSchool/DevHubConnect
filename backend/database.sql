...
', 'mark-zuckerberg.jpg', '$argon2id$v=19$m=65536,t=5,p=1$NJJuWXB2avclJ+7N+ccowQ$nDIEriUSE99xq5e1sXJ3OoBbbsJViyi19bccI/W69QY', 'https://github.com/markzuckerberg', 10, 1, 1, 1), 
...
(4, 'SpaceX', '2024-02-02', '2028-01-01', 'space-x.jpg', 'Le projet SpaceX consiste à développer des fusées et des véhicules spatiaux réutilisables pour rendre l''exploration spatiale plus abordable et accessible à tous.', 'Projet de transport en orbite', 0, 0, 2, 4),
...
(6, 'Neuralink', '2016-06-06', '2022-12-12', 'neuralink.png', 'Neuralink est une entreprise de neurotechnologie fondée par Elon Musk qui développe des interfaces cerveau-machine pour améliorer les capacités humaines.', 'Projet de développement de la connectivité cerveau-machine', 1, 1, 2, 6),
...
(9, 'iPhone', '2007-06-29', '2021-01-01', 'iphone.jpg', 'Le projet iPhone consiste à concevoir un smartphone innovant avec un écran tactile, une caméra, une connectivité sans fil et une interface conviviale et une expérience utilisateur exceptionnelle.', 'Projet de développement de l''iPhone', 1, 0, 3, 1),
