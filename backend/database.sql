...
(9, 'iPhone', '2007-06-29', '2021-01-01', 'iphone.png', 'Le projet iPhone consiste à concevoir un smartphone innovant avec un écran tactile, une caméra, une connectivité sans fil et une interface conviviale pour offrir une expérience utilisateur exceptionnelle.', 'Projet de développement de l''iPhone', 1, 0, 3, 1),
...
(17, 'Hyperloop', '2024-08-12', '2030-12-12', 'hyperloop.jpg', 'Hyperloop est un projet de transport à grande vitesse utilisant des capsules dans des tubes à basse pression pour relier des villes en un temps record, nécessitant des avancées technologiques et des investissements considérables', 'Hyperloop est un système de transport à grande vitesse qui utilise des capsules de transport en position déprimée pour permettre des vitesses élevées tout en réduisant les coûts.', 1, 0, 2, 2);
