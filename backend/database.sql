...
INSERT INTO job (id, jobs_name) VALUES
(1, 'Développeur web'),
(2, 'Designer UX/UI'),
(3, 'Intégrateur web'),
...
INSERT INTO user (cp, firstname, lastname, email, biography, about, user_password, github_page, experience, user_role_id, job_id, location_id) VALUES 
...
', 'password1', 'https://github.com/markzuckerberg', 10, 1, 1, 1), 
('9402200B', 'Elon', 'Musk', 'elon.musk@spacex.com', 'PDG de SpaceX et Tesla', ' Bonjour, je suis Elon Musk, entrepreneur et ingénieur technologique. J ai fondé plusieurs entreprises de pointe, notamment Tesla, SpaceX et The Boring Company, avec pour objectif de rendre la vie meilleure pour tous les êtres humains.
